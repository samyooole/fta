...
df = pd.read_csv('scripts/model/newtota_Substantiated_bypass.csv')
...
totalabels = pd.read_csv('core_excels/tota_chapters.csv')
...
num_epochs=5
model_save_path = 'scripts/model/chaptersFineTuning'
