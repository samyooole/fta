...
myFilters = [expand_contraction, remove_special_character, remove_whitespace, normalize_unicode, remove_url]
...
def splitParasbyArticlewithTagging(text, spare_title, fta_name):
    ...
    for idx,item in enumerate(mid):
        ...
        if article_orig in spl:
            spl.remove(article_orig)
        splitted=spl
